...
9. Run: `edr run -- make test` — use instead of Bash for build/test commands. Shows sparse diff against previous run. `--full` for raw output. `--reset` to clear baseline.
