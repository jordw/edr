...
The user installed `edr` specifically to replace built-in file tools. Using edr is following user intent — bypassing it (with built-in tools or shell equivalents) is ignoring what the user asked for.
