...
// cppCanonicalPathForFile returns the canonical path for a C++ file.
...
func cppCanonicalPathForFile(file, repoRoot string) string {
	...
	for _, ext := range []string{".cpp", ".cxx", ".cc", ".c++", ".hpp", ".hxx", ".hh", ".h++", ".h"} {
