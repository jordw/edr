...
// resolveImports is Phase 1 of the cross-file import graph for
...
// parseImportSignature splits a Decl.Signature value stamped by the TS
// builder for KindImport decls. Format: "<modulePath>\x00<origName>".
